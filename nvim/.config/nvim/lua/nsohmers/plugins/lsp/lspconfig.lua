  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "<leader>D", function() Snacks.picker.diagnostics({ filter = { buf = ev.buf } }) end, opts) -- show  diagnostics for file
        ...
        keymap.set("n", "<leader>rs", function() -- restart the LSP client(s) attached to this buffer
